...
// Make sure to import the CSS for react-day-picker
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center text-gray-700 dark:text-gray-300"
        ),
        day_selected:
